...
<body class="hold-transition <?= e($bodyClass ?? 'layout-top-nav') ?>">

<?php
    // auth pages: login/register/verify/forgot use 'login-page'
    $isAuthPage = isset($bodyClass) && $bodyClass === 'login-page';
?>

<?php if ($isAuthPage): ?>

    <!-- Auth pages (login, register, etc.) – no navbar/footer, just box centered by AdminLTE -->
    <?= $content ?>
    ...
    <div class="wrapper">
        ...
        <footer class="main-footer text-sm text-center">
            <strong>
                ...
                <a href="https://lucifer01430.github.io/Portfolio/" target="_blank">
                    Harsh Pandey
                </a>
            </strong>
